				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<input type="radio" name="notiYn" id="notiYn_Y" value="Y" <c:if test="${boardVO.notiYn eq 'Y' or empty boardVO.notiYn}">checked="checked"</c:if> />
							<label for="notiYn_N">비공지</label>
							<input type="radio" name="notiYn" id="notiYn_N" value="N" <c:if test="${boardVO.notiYn eq 'N'}">checked="checked"</c:if> />
						</td>
						<th scope="row"><strong class="th_tit">기간</strong></th>
						<td>
							<input name="staDate" id="staDate" value="${boardVO.staDate}" class="text"/>
							~
							<input name="endDate" id="endDate" value="${boardVO.endDate}" class="text"/>
						</td>
					</tr>
					<tr>
