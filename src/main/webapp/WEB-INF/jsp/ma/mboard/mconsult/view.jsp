...
var nextprevItem=function(seq,isPrivate='N',rgstId=""){
	if(isPrivate == 'Y' && '${loginMgrAuthCode}'!=1 ){
		alert("비밀글입니다")
		return false
	}
...
<div class="content_box">
	...
	<div class="btn_area">
		<c:if test="${loginMgrAuthCode eq 1 and empty replyVO}">
			<a href="#" id="btn_insert_reply" class="btn btn_mdl btn_rewrite" >답변등록</a> 
		</c:if>
	...
	<div class="btn_area">
		<c:if test="${loginMgrAuthCode eq 1}">
			...
			<a href="#" id="btn_delete_reply" class="btn btn_mdl btn_del" >삭제</a>
		</c:if>
		<a href="#" id="btn_list" class="btn btn_mdl btn_list" >목록</a>
	</div>	
	</c:if>
