...
<div class="content_box">
	...
	<div class="tbl_btns">
		<c:if test="${boardVO.rgstId eq loginFtSeq}">
			<a href="#" id="btn_update" class="btn btn_mdl btn_purple" >수정</a> 
			<a href="#" id="btn_del" class="btn btn_mdl btn_red" >삭제</a>
		</c:if>
		<a href="#" id="btn_list" class="btn btn_mdl btn_gray" >목록</a>
	</div>	
	</form:form>
