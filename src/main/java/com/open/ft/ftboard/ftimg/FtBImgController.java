package com.open.ft.ftboard.ftimg;
...
public class FtBImgController {
    ...
    /** Program ID **/
    private final static String PROGRAM_ID = "BImg";

    /** folderPath **/
    private final static String folderPath = "/ft/ftboard/ftimg/";
