package com.open.ft.ftboard.ftreply;
 ...
 */
@Controller
public class FtBReplyController {
	...
	/** Program ID **/
	private final static String PROGRAM_ID = "BReply";

	/** folderPath **/
	private final static String folderPath = "/ft/ftboard/ftreply/";
