package com.open.ft.ftportfo.ftbexample;
 ...
 */
@Controller
public class FtBExampleController {
    ...
    /** Program ID **/
    private final static String PROGRAM_ID = "BExample";

    /** folderPath **/
    private final static String folderPath = "/ft/ftportfo/ftbexample/";
	...
	public String view(@ModelAttribute("searchVO") BImgVO searchVO, Model model, HttpServletRequest request) throws Exception {
		...
		BImgVO prevItem=(BImgVO) cmmnService.selectContents(boardVO, PROGRAM_ID+".selectPrevContents");
		BImgVO nextItem=(BImgVO) cmmnService.selectContents(boardVO, PROGRAM_ID+".selectNextContents");
