package com.open.ft.ftportfo.ftinte;
...
public class FtInteController {
    ...
    /** Program ID **/
    private final static String PROGRAM_ID = "BInte";

    /** folderPath **/
    private final static String folderPath = "/ft/ftportfo/ftinte/";
